...
if pdf_path:
    ...
    with col2:
        ...
        st.markdown("""<div style="height: 800px; overimport streamlit as st
from PyPDF2 import PdfReader
from langdetect import detect
from gtts import gTTS
import tempfile
...
flow-y: scroll; padding: 10px; border: 1px solid #ccc; background-color: #f9f9f9;">""", unsafe_allow_html=True)
